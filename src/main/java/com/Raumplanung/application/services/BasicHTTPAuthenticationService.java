...
public class BasicHTTPAuthenticationService extends HTTPAuthenticationService {
	public final boolean authenticate(String base64EncodedCredentials) {
		...
		return authenticate(Integer.parseInt(name), password);//TBC
	}
	...
	@Override
	public boolean authenticate(int personalnummer, String password) {
		return nutzerRepository.countByPersonalnummerAndPasswort(personalnummer,password) == 1;
	}
